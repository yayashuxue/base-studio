...
final class ScreenDimensionsTests: XCTestCase {
    ...
    func testNativeRetinaPassesThroughUnclamped() {
        // 3024×1964 (14" MBP framebuffer) is under the 4096 ceiling and already
        // even — it must survive unchanged, i.e. we record at full resolution.
